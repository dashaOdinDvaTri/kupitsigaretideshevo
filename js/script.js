...
function okno(){
document.getElementById("12").className="forma1";
document.getElementById("timer_wrap").className="timer_wrap1";
document.getElementById("window1").className="window1";


}
function okno_z(){
document.getElementById("12").className="forma";
document.getElementById("timer_wrap").className="timer_wrap";
document.getElementById("window1").className="window";
...
function get_timer() {
	...
	var date_new = "December 17,2017 02:00";
	////////////////////////////////////
	////////////////////////////////////
